...
def print_class(class_id, score_id, category_index):

    if score_id >= 90:
        name_class = list(category_index.values())
        name_class_final = name_class[class_id]["name"]
...
while True:
    ...
    final = print_class(class_final, score_final,category_index)
    print(final)
